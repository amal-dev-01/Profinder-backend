...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('email', 'username', 'phone','first_name', 'last_name', 'userprofile','professionalprofile')
    ...
    def update(self, instance, validated_data):
        ...
        try: 
            ...
            professional.address = professional_data.get('address', professional.address)
            ...
            professional.experience = professional_data.get('experience',professional.experience)
            professional.save()
        except :
            profile=instance.userprofile
